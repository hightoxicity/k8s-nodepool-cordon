module github.com/hightoxicity/k8s-nodepool-cordon
...
require (
	...
	k8s.io/autoscaler/cluster-autoscaler v0.0.0-00010101000000-000000000000 // indirect
...
replace (
	...
	k8s.io/autoscaler/cluster-autoscaler => k8s.io/autoscaler/cluster-autoscaler v0.0.0-20210806164320-0f4669835f4a
